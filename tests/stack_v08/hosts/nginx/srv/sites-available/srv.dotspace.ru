server {
    ...
    ## Reverse-Proxy to internal Dockerized Service :: Grafana
    location /mon/grafana/ {
    ...
    ## Reverse-Proxy to internal Dockerized Service :: BlackboxExporter
    location /mon/blackbox/ {
        # restrict access with basic auth
        auth_basic "Restricted Content";
        auth_basic_user_file /etc/nginx/.htpasswd;
        #
    ...
    ## Reverse-Proxy to internal Dockerized Service :: AlertManager
    location /mon/alerter/ {
        # restrict access with basic auth
        auth_basic "Restricted Content";
        auth_basic_user_file /etc/nginx/.htpasswd;
        #
    ...
    ## Reverse-Proxy to internal Dockerized Service :: cAdvisor
    location /mon/cadv/ {
        # restrict access with basic auth
        auth_basic "Restricted Content";
        auth_basic_user_file /etc/nginx/.htpasswd;
    ...
    ## Reverse-Proxy to internal Dockerized Service :: Portainer
    location /mon/port/ {
        # portainer has built-in auth feature
        #
        # fixing portainer attach-execute container console issue
        proxy_http_version 1.1;
        proxy_set_header Upgrade $http_upgrade;
        proxy_set_header Connection "upgrade";
        #
